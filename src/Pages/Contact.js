...
import { AiFillFacebook, AiFillInstagram, AiOutlineTwitter, AiOutlineMail } from "react-icons/ai"
        ...
        <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
          ...
          <div className>
            ...
            <div>
              ...
              <input required onChange={handleChange} className="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" name='first' type="text" placeholder />
            </div>
            <div>
              <span className="uppercase text-sm text-gray-600 font-bold">Last Name</span>
              <input required onChange={handleChange} className="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" name='last' type="text" placeholder />
            </div>
            </div>
            
            <div className="mt-8">
              <span className="uppercase text-sm text-gray-600 font-bold">Email</span>
              <input required onChange={handleChange} className="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" name='email' type="text" />
            </div>
            <div className="mt-8">
            <span className="uppercase text-sm text-gray-600 font-bold"></span>
            <label htmlFor="" className='text-sm'>
                <select placeholder='subject line' name="option" id="subject input" required onChange={handleChange} className="w-full bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline">
                    <option disabled hidden selected value="">Saya ingin bekerja sama</option>
                    <option value="a">Saya ingin bekerja sama</option>
                    <option value="s">Saya ingin bekerja sama</option>
                    <option value="d">Saya ingin bekerja sama</option>
                </select>
            </label>
            </div>
            <div className="mt-8">
              <span className="uppercase text-sm text-gray-600 font-bold">Message</span>
              <textarea required onChange={handleChange} name='message' className="w-full resize-none h-32 bg-gray-300 text-gray-900 mt-2 p-3 rounded-lg focus:outline-none focus:shadow-outline" defaultValue={""} />
            </div>
            <div className="mt-8">
